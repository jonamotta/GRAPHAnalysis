...
if __name__ == "__main__" :
    ...
    outdir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_reducedEtaCoverage/hdf5dataframes/matched'
    os.system('mkdir -p '+outdir)

    # set output to go both to terminal and to file
    sys.stdout = Logger("/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_reducedEtaCoverage/hdf5dataframes/matched/info.log")
    ...
    for name in feNames_dict:
        ...
        if args.doHH:
            ...
            df_gentau.query('gentau_vis_eta>=-2.2 and gentau_vis_eta<=2.2', inplace=True) # stay looser on gen taus for safety in the calculation
            dfHH_towers.query('tower_eta>=-2.2 and tower_eta<=2.2', inplace=True) # stay looser on towers for safety in the calculations
        ...
        if args.doTenTau:
            ...
            df_cl3d.query('cl3d_eta>=-2.1 and cl3d_eta<=2.1', inplace=True)
            df_gentau.query('gentau_vis_eta>=-2.2 and gentau_vis_eta<=2.2', inplace=True) # stay looser on gen taus for safety in the calculation
            dfTenTau_towers.query('tower_eta>=-2.2 and tower_eta<=2.2', inplace=True) # stay looser on towers for safety in the calculations
        ...
        if args.doSingleTau:
            ...
            df_cl3d.query('cl3d_eta>=-2.1 and cl3d_eta<=2.1', inplace=True)
            df_gentau.query('gentau_vis_eta>=-2.2 and gentau_vis_eta<=2.2', inplace=True) # stay looser on gen taus for safety in the calculation
            dfSingleTau_towers.query('tower_eta>=-2.2 and tower_eta<=2.2', inplace=True) # stay looser on towers for safety in the calculations
        ...
        if args.doVBFH:
            ...
            df_cl3d.query('cl3d_eta>=-2.1 and cl3d_eta<=2.1', inplace=True)
            df_gentau.query('gentau_vis_eta>=-2.2 and gentau_vis_eta<=2.2', inplace=True) # stay looser on gen taus for safety in the calculation
            dfVBFH_towers.query('tower_eta>=-2.2 and tower_eta<=2.2', inplace=True) # stay looser on towers for safety in the calculations
        ...
        if args.doZprime:
            ...
            df_cl3d.query('cl3d_eta>=-2.1 and cl3d_eta<=2.1', inplace=True)
            df_gentau.query('gentau_vis_eta>=-2.2 and gentau_vis_eta<=2.2', inplace=True) # stay looser on gen taus for safety in the calculation
            dfZprime_towers.query('tower_eta>=-2.2 and tower_eta<=2.2', inplace=True) # stay looser on towers for safety in the calculations
        ...
        if args.doQCD:
            ...
            df_cl3d.query('cl3d_eta>=-2.1 and cl3d_eta<=2.1', inplace=True)
            df_genjet.query('genjet_eta>=-2.2 and genjet_eta<=2.2', inplace=True) # stay looser on gen taus for safety in the calculation
            dfQCD_towers.query('tower_eta>=-2.2 and tower_eta<=2.2', inplace=True) # stay looser on towers for safety in the calculations
        ...
        if args.doNu:
            ...
            dfNu.query('cl3d_eta>=-2.1 and cl3d_eta<=2.1', inplace=True)
            dfNu_towers.query('tower_eta>=-2.2 and tower_eta<=2.2', inplace=True) # stay looser on towers for safety in the calculations
