...
if __name__ == "__main__" :
    ...
    indir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_reducedEtaCoverage/hdf5dataframes/isolated_skimPUnoPt{0}{1}'.format(tag1, '_'+tag2)
    outdir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_reducedEtaCoverage/hdf5dataframes/isolated_skimPUnoPt{0}_skimISO{0}{1}_againstPU'.format(tag1, tag2)
    plotdir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_reducedEtaCoverage/plots/isolation_skimPUnoPt_skimISO{0}{1}_PUWP{2}_againstPU'.format(tag1, tag2, args.PUWP)
    model_outdir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_reducedEtaCoverage/pklModels/isolation_skimPUnoPt{0}_skimISO{0}{1}_againstPU'.format(tag1, tag2)
    os.system('mkdir -p '+indir+'; mkdir -p '+outdir+'; mkdir -p '+plotdir+'; mkdir -p '+model_outdir)

    # set output to go both to terminal and to file
    sys.stdout = Logger("/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_reducedEtaCoverage/pklModels/isolation_skimPUnoPt{0}_skimISO{0}{1}_againstPU/performance_PUWP{2}.log".format(tag1, tag2, args.PUWP))
