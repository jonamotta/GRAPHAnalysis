...
if __name__ == "__main__" :
    ...
    indir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT/hdf5dataframes/DMtesting'
    outdir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT/hdf5dataframes/DMtesting'
    plotdir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT/hdf5dataframes/DMtesting'
    model_dict_outdir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT/hdf5dataframes/DMtesting'
    os.system('mkdir -p '+indir+'; mkdir -p '+outdir+'; mkdir -p '+plotdir+'; mkdir -p '+model_dict_outdir)

    # set output to go both to terminal and to file
    sys.stdout = Logger("/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT/hdf5dataframes/DMtesting/DMtesting.log")
    ...
    features = ['cl3d_pt_tr', 'cl3d_c1', 'cl3d_c2', 'cl3d_c3', 'c1oc3', 'c1oc2', 'c2oc3', 'c1oPt', 'c2oPt', 'c3oPt', 'c1oPtc1', 'c2oPtc2', 'c3oPtc3', 'fullScale', 'cl3d_abseta', 'cl3d_showerlength', 'cl3d_coreshowerlength', 'cl3d_firstlayer', 'cl3d_seetot', 'cl3d_seemax', 'cl3d_spptot', 'cl3d_sppmax', 'cl3d_szz', 'cl3d_srrtot', 'cl3d_srrmax', 'cl3d_srrmean', 'cl3d_hoe', 'cl3d_meanz']
    # the saturation and shifting values are calculated in the "features_reshaping" JupyScript
    features2shift = ['cl3d_showerlength', 'cl3d_coreshowerlength', 'cl3d_firstlayer',]
    ...
    features_dict = {'cl3d_c1'               : [r'3D cluster C1',[0,30,30]],
                     ...
                     'c1oc3'                 : [r'3D cluster c1oc3',[0,35.,0.5]],
                     'c1oc2'                 : [r'3D cluster c1oc2',[0,33.,66]],
                     'c2oc3'                 : [r'3D cluster c2oc3',[0,3,0.1]],
                     'c1oPt'                 : [r'3D cluster c1oPt',[0,33.,66]],
                     'c2oPt'                 : [r'3D cluster c2oPt',[0,33.,66]],
                     'c3oPt'                 : [r'3D cluster c3oPt',[0,33.,66]],
                     'c1oPtc1'               : [r'3D cluster c1oPtc1',[0,33.,66]],
                     'c2oPtc2'               : [r'3D cluster c2oPtc2',[0,33.,66]],
                     'c3oPtc3'               : [r'3D cluster c3oPtc3',[0,33.,66]],
                     'fullScale'             : [r'3D cluster fullScale',[0,33.,66]],
                     'cl3d_pt_tr'            : [r'3D cluster $p_{T}$',[0.,500.,50]],
    ...
    if args.doRescale:
        features_dict = {'cl3d_c1'               : [r'3D cluster C1',[-33.,33.,66]],
                         ...
                         'cl3d_pt_tr'            : [r'3D cluster $p_{T}$',[-33.,33.,66]], 
    ...
    for name in feNames_dict:
        ...
        RFC = RandomForestClassifier(n_jobs=10, random_state=0, bootstrap=True, max_samples=0.8, class_weight='balanced_subsample', max_depth=5, n_estimators=100)
        #model_dict[name] = OVRC(RFC).fit(inputs,target)
