...
if __name__ == "__main__" :
    ...
    if args.doRead:
        ...
        outdir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_reducedEtaCoverage/hdf5dataframes/rateEvluation'
        ...
        if args.testRun:
            ...
            df_cl3d.query('cl3d_eta>=-2.1 and cl3d_eta<=2.1', inplace=True)
            towers.query('tower_eta>=-2.2 and tower_eta<=2.2', inplace=True) # stay looser on towers for safety in the calculations
        ...
        # create needed folders
        indir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_reducedEtaCoverage/hdf5dataframes/rateEvluation'
        outdir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_reducedEtaCoverage/hdf5dataframes/rateEvluation'
        os.system('mkdir -p '+outdir)
    ...
    if args.doApply:
        ...
        calib_model_indir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_reducedEtaCoverage/pklModels/calibration_C1skimC2C3'
        ...
        PUrej_model_indir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_reducedEtaCoverage/pklModels/PUrejection_skimPUnoPtRscld'
        ...
        isoQCDrej_model_indir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_reducedEtaCoverage/pklModels/isolation_skimPUnoPtRscld_skimISORscld{0}{1}_againstPU'
        ...
        WP20_isoQCDrej = {
            'threshold'    : isoQCDrej_model_indir+'/WP20_isolation_PUWP{0}_th_PU200.pkl',
            'mixed'        : isoQCDrej_model_indir+'/'
        }

        WP90_isoQCDrej = {
            'threshold'    : isoQCDrej_model_indir+'/WP90_isolation_PUWP{0}_th_PU200.pkl',
            'mixed'        : isoQCDrej_model_indir+'/'
        }

        WP95_isoQCDrej = {
            'threshold'    : isoQCDrej_model_indir+'/WP95_isolation_PUWP{0}_th_PU200.pkl',
            'mixed'        : isoQCDrej_model_indir+'/'
        }

        WP99_isoQCDrej = {
            'threshold'    : isoQCDrej_model_indir+'/WP99_isolation_PUWP{0}_th_PU200.pkl',
            'mixed'        : isoQCDrej_model_indir+'/'
        }

        # DICTIONARIES FOR THE DM SORTING
        # DMsort_model_indir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_reducedEtaCoverage/pklModels/DMsorting_skimPUnoPtRscld_skimISORscld{0}'.format(tag1)
        ...
        L1TowerEtIso(dfL1Candidates_p_d, dfL1Towers_p_d, 0.1, 0.3) # dRsgn, dRiso
        ...
        L1TowerEtIso(dfL1Candidates_p_m, dfL1Towers_p_m, 0.1, 0.3) # dRsgn, dRiso
        ...
        L1TowerEtIso(dfL1Candidates_p_u, dfL1Towers_p_u, 0.1, 0.3) # dRsgn, dRiso
        ...
        L1TowerEtIso(dfL1Candidates_m_d, dfL1Towers_m_d, 0.1, 0.3) # dRsgn, dRiso
        ...
        L1TowerEtIso(dfL1Candidates_m_m, dfL1Towers_m_m, 0.1, 0.3) # dRsgn, dRiso
        ...
        L1TowerEtIso(dfL1Candidates_m_u, dfL1Towers_m_u, 0.1, 0.3) # dRsgn, dRiso
        ...
        for PUWP in ['99', '95', '90']:
            if PUWP == '99':
                features_isoQCDrej = ['cl3d_pt_tr', 'cl3d_abseta', 'cl3d_coreshowerlength', 'cl3d_spptot', 'cl3d_srrtot', 'cl3d_srrmean', 'cl3d_hoe', 'cl3d_meanz', 'cl3d_NclIso_dR4', 'tower_etSgn_dRsgn1', 'tower_etSgn_dRsgn2', 'tower_etIso_dRsgn1_dRiso3']

            elif PUWP == '95':
                features_isoQCDrej = ['cl3d_pt_tr', 'cl3d_abseta', 'cl3d_coreshowerlength', 'cl3d_srrtot', 'cl3d_srrmean', 'cl3d_hoe', 'cl3d_meanz', 'cl3d_NclIso_dR4', 'tower_etSgn_dRsgn1', 'tower_etSgn_dRsgn2', 'tower_etIso_dRsgn1_dRiso3']

            else:
                features_isoQCDrej = ['cl3d_pt_tr', 'cl3d_abseta', 'cl3d_spptot', 'cl3d_srrtot', 'cl3d_srrmean', 'cl3d_hoe', 'cl3d_meanz', 'cl3d_NclIso_dR4', 'tower_etSgn_dRsgn1', 'tower_etSgn_dRsgn2', 'tower_etIso_dRsgn1_dRiso3']

            print('    - PUWP = {0}'.format(PUWP))
            model_iso = load_obj(model_isoQCDrej[args.FE].format(PUWP,tag3))
            ISObdtWP10 = load_obj(WP10_isoQCDrej[args.FE].format(PUWP,tag3))
            ISObdtWP15 = load_obj(WP15_isoQCDrej[args.FE].format(PUWP,tag3))
            ISObdtWP20 = load_obj(WP20_isoQCDrej[args.FE].format(PUWP,tag3))
            ISObdtWP90 = load_obj(WP90_isoQCDrej[args.FE].format(PUWP,tag3))
            ISObdtWP95 = load_obj(WP95_isoQCDrej[args.FE].format(PUWP,tag3))
            ISObdtWP99 = load_obj(WP99_isoQCDrej[args.FE].format(PUWP,tag3))
            ...
            df4Rate['cl3d_isobdt_passWP20_PUWP{0}'.format(PUWP)] = df4Rate['cl3d_isobdt_score'] > ISObdtWP20
            df4Rate['cl3d_isobdt_passWP90_PUWP{0}'.format(PUWP)] = df4Rate['cl3d_isobdt_score'] > ISObdtWP90
            df4Rate['cl3d_isobdt_passWP95_PUWP{0}'.format(PUWP)] = df4Rate['cl3d_isobdt_score'] > ISObdtWP95
            df4Rate['cl3d_isobdt_passWP99_PUWP{0}'.format(PUWP)] = df4Rate['cl3d_isobdt_score'] > ISObdtWP99
            del full, model_iso, ISObdtWP10, ISObdtWP15, ISObdtWP20, ISObdtWP90, ISObdtWP95, ISObdtWP99

        del features_isoQCDrej, model_isoQCDrej, WP10_isoQCDrej, WP15_isoQCDrej, WP20_isoQCDrej, WP90_isoQCDrej, WP95_isoQCDrej, WP99_isoQCDrej # free memory
    ...
    if args.doRate:
        ...
        mapping_indir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_reducedEtaCoverage/pklModels/mapping_skimPUnoPtRscld_skimISORscld{0}'.format(tag1)
        ratedir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_reducedEtaCoverage/pklModels/rateEvaluation_C1skimC2C3_skimPUnoPtRscld_skimISORscld{0}'.format(tag1)
    ...
    if args.doPlots:
        plotdir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_reducedEtaCoverage/plots/rateEvaluation_C1skimC2C3_skimPUnoPtRscld_skimISORscld{0}_pt{1}'.format(tag1,args.ptcut)
        ratedir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_reducedEtaCoverage/pklModels/rateEvaluation_C1skimC2C3_skimPUnoPtRscld_skimISORscld{0}'.format(tag1)
        os.system('mkdir -p '+plotdir)
        rates_offline = load_obj(ratedir+'/offlineRate_pt{0}.pkl'.format(args.ptcut))

        # set output to go both to terminal and to file
        sys.stdout = Logger("/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_reducedEtaCoverage/pklModels/rateEvaluation_C1skimC2C3_skimPUnoPtRscld_skimISORscld{0}/offlineThresholds_pt{1}.txt".format(tag1,args.ptcut))
