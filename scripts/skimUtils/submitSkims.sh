...
#python scripts/skimUtils/skimNtuple.py --gen3Dmatch 0   --isTau 0   --isQCD 0   --input inputFiles/Minbias_v11/Minibias_PU200_210518.txt                             --output $SKIMDIR/$HASHDIR/SKIM_Minbias_PU200                     --tag $HASHDIR/SKIM_Minbias_PU200                    --njobs 20 --queue long --sleep True
