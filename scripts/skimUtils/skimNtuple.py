...
if __name__ == "__main__":
    ...
    parser.add_option('--isTau', dest='isTau', help='is the skimming done for Tau datasets?', default=0)
    parser.add_option('--isQCD', dest='isQCD', help='is the skimming done for QCD datasets?', default=0)
    parser.add_option('--isTT', dest='isTT', help='is the skimming done for TT datasets?', default=0)
    parser.add_option('--nEvents', dest='nEvents', help='number of events to process', default=-1)
    parser.add_option('--gen3Dmatch', dest='gen3Dmatch', help='do generator level particles - 3D clusters matching?', default=0)
