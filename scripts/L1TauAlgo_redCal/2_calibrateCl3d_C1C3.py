...
if __name__ == "__main__" :
    ...
    outdir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT/hdf5dataframes/calibrated_C1C3'
    plotdir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT/plots/calibration_C1C3'
    model_outdir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT/pklModels/calibration_C1C3'
    ...
    vars = ['gentau_vis_pt', 'gentau_vis_bin_pt', 'cl3d_pt_c1', 'cl3d_response_c1']

    # variables to plot
    plot_var = ['gentau_vis_pt', 'gentau_vis_abseta', 'gentau_vis_bin_eta', 'gentau_vis_bin_pt', 'cl3d_pt', 'cl3d_response', 'cl3d_abseta', 'cl3d_pt_c1', 'cl3d_response_c1', 'cl3d_pt_c3', 'cl3d_response_c3']
    ...
    for name in feNames_dict:
        ...
        meansTrainPt_dict[name]['logpt1'] = np.log(meansTrainPt_dict[name]['cl3d_pt_c1'])
        ...
        logpt1 = np.log(abs(dfValidation_dict[name]['cl3d_pt_c1']))
        logpt2 = logpt1**2
        logpt3 = logpt1**3
        logpt4 = logpt1**4
        dfValidation_dict[name]['cl3d_c3'] = C3model_dict[name].predict(np.vstack([logpt1, logpt2, logpt3, logpt4]).T)
        dfValidation_dict[name]['cl3d_pt_c3'] = dfValidation_dict[name].cl3d_pt_c1 / dfValidation_dict[name].cl3d_c3
        ...
        # application calibration 3
        logpt1 = np.log(abs(dfTraining_dict[name]['cl3d_pt_c1']))
        logpt2 = logpt1**2
        logpt3 = logpt1**3
        logpt4 = logpt1**4
        dfTraining_dict[name]['cl3d_c3'] = C3model_dict[name].predict(np.vstack([logpt1, logpt2, logpt3, logpt4]).T)
        dfTraining_dict[name]['cl3d_pt_c3'] = dfTraining_dict[name].cl3d_pt_c1 / dfTraining_dict[name].cl3d_c3
        ...
        # application calibration 3
        logpt1 = np.log(abs(dfVal['cl3d_pt_c1']))
        logpt2 = logpt1**2
        logpt3 = logpt1**3
        logpt4 = logpt1**4
        dfVal['cl3d_c3'] = C3model_dict[name].predict(np.vstack([logpt1, logpt2, logpt3, logpt4]).T)
        dfVal['cl3d_pt_c3'] = dfVal.cl3d_pt_c1 / dfVal.cl3d_c3
        ...
        # application calibration 3
        logpt1 = np.log(abs(dfQCDVal['cl3d_pt_c1']))
        logpt2 = logpt1**2
        logpt3 = logpt1**3
        logpt4 = logpt1**4
        dfQCDVal['cl3d_c3'] = C3model_dict[name].predict(np.vstack([logpt1, logpt2, logpt3, logpt4]).T)
        dfQCDVal['cl3d_pt_c3'] = dfQCDVal.cl3d_pt_c1 / dfQCDVal.cl3d_c3
        ...
        # application calibration 3
        logpt1 = np.log(abs(dfQCDTr['cl3d_pt_c1']))
        logpt2 = logpt1**2
        logpt3 = logpt1**3
        logpt4 = logpt1**4
        dfQCDTr['cl3d_c3'] = C3model_dict[name].predict(np.vstack([logpt1, logpt2, logpt3, logpt4]).T)
        dfQCDTr['cl3d_pt_c3'] = dfQCDTr.cl3d_pt_c1 / dfQCDTr.cl3d_c3
