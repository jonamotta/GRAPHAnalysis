...
if __name__ == "__main__" :
    ...
    indir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT/hdf5dataframes/calibrated_C3'
    outdir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT/hdf5dataframes/PUrejected_C3_redPUnoPt'
    plotdir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT/plots/PUrejection_C3_redPUnoPt'
    model_outdir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT/pklModels/PUrejection_C3_redPUnoPt'
    os.system('mkdir -p '+indir+'; mkdir -p '+outdir+'; mkdir -p '+plotdir+'; mkdir -p '+model_outdir)

    # set output to go both to terminal and to file
    sys.stdout = Logger("/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT/pklModels/PUrejection_C3_redPUnoPt/performance.log")
    ...
    features = ['cl3d_c3', 'cl3d_abseta', 'cl3d_showerlength', 'cl3d_coreshowerlength', 'cl3d_firstlayer', 'cl3d_seetot', 'cl3d_seemax', 'cl3d_spptot', 'cl3d_sppmax', 'cl3d_szz', 'cl3d_srrtot', 'cl3d_srrmax', 'cl3d_srrmean', 'cl3d_hoe', 'cl3d_meanz']
    ...
    for name in feNames_dict:
        ...
        print('\n**INFO: bkg efficiency at: 0.99 sgn efficiency {0} -  0.95 sgn efficiency {1} -  0.90 sgn efficiency {2}'.format(np.interp(0.99, tpr_test_dict[name], fpr_test_dict[name]),np.interp(0.95, tpr_test_dict[name], fpr_test_dict[name]),np.interp(0.90, tpr_test_dict[name], fpr_test_dict[name])))
...
if args.doPlots:
    ...
    features_dict = {'cl3d_c3'               : [r'C3 factor value',[0.75,1.,50]],
    ...
    for name in feNames_dict:
        ...
        for var in features_dict:
            if var not in features: continue
        ...
        corrMatrix = dfTraining_dict[name][features].corr()
        plt.figure(figsize=(15,15))
        sn.heatmap(corrMatrix, annot=True)
        plt.savefig(plotdir+'/correlation_matrix.pdf')
        plt.close()
