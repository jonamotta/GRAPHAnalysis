...
if __name__ == "__main__" :
    ...
    for name in feNames_dict:
        ...
        if args.doPlots:    
            ...
            plt.hist(dfValidationDM10_dict[name]['cl3d_response'], bins=np.arange(0., 2., 0.03),  label=r'3-prong, mean: {0}, RMS: {1}'.format(round(dfValidation_dict[name]['cl3d_response'].mean(),3), round(dfValidationDM10_dict[name]['cl3d_response'].std(),3)), color='red',  histtype='step', lw=2)
            ...
            plt.hist(dfValidationDM10_dict[name]['cl3d_response_c1'], bins=np.arange(0., 2., 0.03),  label=r'3-prong, mean: {0}, RMS: {1}'.format(round(dfValidation_dict[name]['cl3d_response_c1'].mean(),3), round(dfValidationDM10_dict[name]['cl3d_response_c1'].std(),3)), color='red',  histtype='step', lw=2)
            ...
            plt.hist(dfValidationDM10_dict[name]['cl3d_response_c2'], bins=np.arange(0., 2., 0.03),  label=r'3-prong, mean: {0}, RMS: {1}'.format(round(dfValidation_dict[name]['cl3d_response_c2'].mean(),3), round(dfValidationDM10_dict[name]['cl3d_response_c2'].std(),3)), color='red',  histtype='step', lw=2)
            ...
            plt.hist(dfValidationDM10_dict[name]['cl3d_response_c3'], bins=np.arange(0., 2., 0.03),  label=r'3-prong, mean: {0}, RMS: {1}'.format(round(dfValidation_dict[name]['cl3d_response_c3'].mean(),3), round(dfValidationDM10_dict[name]['cl3d_response_c3'].std(),3)), color='red',  histtype='step', lw=2)
