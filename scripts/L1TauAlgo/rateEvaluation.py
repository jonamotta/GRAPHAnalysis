...
if __name__ == "__main__" :
    ...
    if args.doApply:
        ...
        calib_model_indir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT/pklModels/calibration_C1skimC2C3'
        ...
        PUrej_model_indir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT/pklModels/PUrejection_skimPUnoPtRscld'
        ...
        isoQCDrej_model_indir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT/pklModels/isolation_skimPUnoPtRscld_skimISORscld{0}{1}_againstPU'
        ...
        # DMsort_model_indir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT/pklModels/DMsorting_skimPUnoPtRscld_skimISORscld{0}'.format(tag1)
    ...
    if args.doRate:
        ...
        mapping_indir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT/pklModels/mapping_skimPUnoPtRscld_skimISORscld{0}'.format(tag1)
        ratedir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT/pklModels/rateEvaluation_C1skimC2C3_skimPUnoPtRscld_skimISORscld{0}'.format(tag1)
    ...
    if args.doPlots:
        plotdir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT/plots/rateEvaluation_C1skimC2C3_skimPUnoPtRscld_skimISORscld{0}_pt{1}'.format(tag1,args.ptcut)
        ratedir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT/pklModels/rateEvaluation_C1skimC2C3_skimPUnoPtRscld_skimISORscld{0}'.format(tag1)
        os.system('mkdir -p '+plotdir)
        rates_offline = load_obj(ratedir+'/offlineRate_pt{0}.pkl'.format(args.ptcut))

        # set output to go both to terminal and to file
        sys.stdout = Logger("/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT/pklModels/rateEvaluation_C1skimC2C3_skimPUnoPtRscld_skimISORscld{0}/offlineThresholds_pt{1}.txt".format(tag1, args.ptcut))
