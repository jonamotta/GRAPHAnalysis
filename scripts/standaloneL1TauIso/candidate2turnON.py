...
if __name__ == "__main__" :
    ...
    plotdir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT/plots/rateEvaluation/turnONs'
    ...
    outFileTau_mapping_dict = {
        'threshold'    : outdir+'/RateEval_PU200_th_isolation_PUWP{0}_ISOWP{1}_mapping.pkl'.format(args.PUWP,args.ISOWP),
        'supertrigger' : outdir+'/',
        'bestchoice'   : outdir+'/',
        'bestcoarse'   : outdir+'/',
        'mixed'        : outdir+'/'
    ...
    for name in feNames_dict:
        ...
        dfTau_dict[name] = pd.concat([dfL1_tentau, dfL1_singletau, dfL1_HH], sort=False)

        ######################### SELECT EVENTS #########################   
        
        dfTau_dict[name].query('cl3d_pubdt_passWP{0}==True and cl3d_isobdt_passWP{1}_PUWP{0}==True'.format(args.PUWP,args.ISOWP), inplace=True)
        ...
        eff_err_low_TauDM0 = dfTauDM0['efficiency_err_low_at30GeV']
        eff_err_low_TauDM1 = dfTauDM1['efficiency_err_low_at30GeV']
        eff_err_low_TauDM2 = dfTauDM2['efficiency_err_low_at30GeV']
        eff_err_up_TauDM0 = dfTauDM0['efficiency_err_up_at30GeV']
        eff_err_up_TauDM1 = dfTauDM1['efficiency_err_up_at30GeV']
        eff_err_up_TauDM2 = dfTauDM2['efficiency_err_up_at30GeV']
...
for name in feNames_dict:
    ...
    popt, pcov = curve_fit(sigmoid, df['gentau_vis_pt'], eff, p0)
