...
if __name__ == "__main__" :
    ...
    indir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_redEta/hdf5dataframes/isolated_C1fullC2C3_fullPUnoPt_fullISO'.format(args.PUWP)
    outdir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_redEta/hdf5dataframes/DMsorted_C1fullC2C3_fullPUnoPt_fullISO'
    plotdir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_redEta/plots/DMsorting_C1fullC2C3_fullPUnoPt_PUWP{0}_fullISO_ISOWP{1}'.format(args.PUWP,args.ISOWP)
    model_dict_outdir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_redEta/pklModels/DMsorting_C1fullC2C3_fullPUnoPt_fullISO'
    os.system('mkdir -p '+indir+'; mkdir -p '+outdir+'; mkdir -p '+plotdir+'; mkdir -p '+model_dict_outdir)

    # set output to go both to terminal and to file
    sys.stdout = Logger("/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_redEta/pklModels/DMsorting_C1fullC2C3_fullPUnoPt_fullISO/performance_PUWP{0}_ISOWP{1}.log".format(args.PUWP,args.ISOWP))
