...
if __name__ == "__main__" :
    ...
    parser.add_argument('--effFitLimit', dest='effFitLimit', help='how many gentau_pt bins you want to consider for the fit of the turnON? (default: 33 bins = <102GeV)', default=33)
    ...
    indir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_redEta/hdf5dataframes/isolated_C1fullC2C3_fullPUnoPt'
    outdir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_redEta/hdf5dataframes/isolated_C1fullC2C3_fullPUnoPt_fullISO'
    plotdir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_redEta/plots/isolation_C1fullC2C3_fullPUnoPt_fullISO'
    model_outdir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_redEta/pklModels/isolation_C1fullC2C3_fullPUnoPt_fullISO'
    os.system('mkdir -p '+indir+'; mkdir -p '+outdir+'; mkdir -p '+plotdir+'; mkdir -p '+model_outdir)

    # set output to go both to terminal and to file
    sys.stdout = Logger("/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT_redEta/pklModels/isolation_C1fullC2C3_fullPUnoPt_fullISO/performance_PUWP{0}.log".format(args.PUWP))
