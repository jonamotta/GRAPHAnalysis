...
if __name__ == "__main__" :
    ...
    plotdir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT/ISOrejectionBDTskimmingAndOptimization{0}/FS'.format("_Rscld" if args.doRescale else "")
