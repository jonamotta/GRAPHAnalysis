...
if __name__ == "__main__" :
    ...
    plotdir = '/home/llr/cms/motta/HGCAL/CMSSW_11_1_0/src/GRAPHAnalysis/L1BDT/C2skimmingAndOptimization{0}/FS_depth5'.format("_Rscld" if args.doRescale else "")
    ...
    tokeep = ['gentau_vis_pt', 'cl3d_pt', 'cl3d_abseta', 'cl3d_coreshowerlength', 'cl3d_seetot', 'cl3d_srrmean', 'cl3d_srrtot', 'cl3d_spptot', 'cl3d_meanz', 'cl3d_showerlength', 'cl3d_hoe', 'cl3d_szz', 'cl3d_seemax', 'cl3d_firstlayer', 'cl3d_sppmax', 'cl3d_srrmax']
    dfTr = dfTr[tokeep]
    ...
    inputFeats = dfTr[featuresRNDM] ; target = dfTr['gentau_vis_pt'] / dfTr['cl3d_pt_c1']

    # do random search
    print('\n** INFO: doing random search')
    FS = ModuleRegressorOptimizer.RegressorOptimizer('C2calibration', dfTr, featuresRNDM, target, 2)
    randomScores, randomFeats = FS.RandomSearch(inputFeats, target)
