...
if __name__ == "__main__" :
    ...
    for name in feNames_dict:
        ...
        dfQCD_dict[name]['gentau_decayMode'].replace([0,5,10], 0, inplace=True)
        dfTau_dict[name]['gentau_decayMode'].replace([1], 1, inplace=True)
        dfHH_dict[name]['gentau_decayMode'].replace([1], 1, inplace=True)
        dfQCD_dict[name]['gentau_decayMode'].replace([1], 1, inplace=True)
        dfTau_dict[name]['gentau_decayMode'].replace([11], 2, inplace=True)
        dfHH_dict[name]['gentau_decayMode'].replace([11], 2, inplace=True)
        dfQCD_dict[name]['gentau_decayMode'].replace([11], 2, inplace=True)
        dfTau_dict[name]['gentau_decayMode'].replace([4], 3, inplace=True)
        dfHH_dict[name]['gentau_decayMode'].replace([4], 3, inplace=True)
        ...
        if args.doPlots:
            for name in feNames_dict:
                ...
                plt.xticks([0,1,2,3], ('prong', r'1-prong$+\pi_0$', r'3-prong$+\pi_0$', 'QCD'))
                plt.yticks([0,1,2,3], ('prong', r'1-prong$+\pi_0$', r'3-prong$+\pi_0$', 'QCD'))
                plt.xlim(-0.5, 3.5)
                plt.ylim(-0.5, 3.5)
